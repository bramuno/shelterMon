...
<h2>ESP32 & sensors</h2>
  ...
  <li>read <a href="https://docs.espressif.com/projects/esp-idf/en/latest/esp32/get-started/index.html">this guide</a> on getting to know the basics on the ESP32, follow the instructions to setup arduino IDE and pay attention on how to upload code to the board.  It requires you hold the reset button until the board begins uploading, so it may take some practice. </li>
