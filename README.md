...
<br>
For example, the best temperature monitor I could find on amazon that could do everything in this project was ~$80 for one unit.  Our shelter has 9 locations to monitor, so already that's several hundred dollars for a non-profit, low-budget animal shelter.  This project reduces costs to ~$16 per location plus the cost of a raspberry pi, or you could use free tier on AWS to skip the raspberry pi.  
<br>
